    ...
    <>
      ...
      <MainContainer className="flex flex-col gap-5 montserrat">
        <section className="flex flex-col gap-8">
          ...
          <div className="flex gap-4 flex-wrap justify-center items-center w-full min-h-300px bg-wise-hyper_black rounded-lg p-4">
            <img
              src={
              ...
              alt="Foto de perfil"
              className="max-w-[350px] min-h-[250px] flex-1 rounded-md object-cover border-none"
            />
